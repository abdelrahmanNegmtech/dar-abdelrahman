...
function Sidebar() {
  ...
  return <aside className="w-[205px] shrink-0 border-r border-[#eff1f7] px-[18px] py-[16px] max-[760px]:hidden">
    ...
    <div className="owner-body mt-[25px] h-[194px] overflow-hidden rounded-[8px] bg-[#f6f1ff] px-[14px] pt-[14px]"><b className="owner-label">List more, earn more</b><p className="owner-body mt-[4px]">Complete your property and<br />start welcoming guests.</p><Link href="/add-property" className="owner-button-text mt-[10px] grid h-[34px] place-items-center rounded-[5px] border border-[#9c7cff] bg-white">Finish property</Link><div className="relative mx-auto mt-[4px] h-[69px] w-[132px]"><Image src="/finish-property-illustration.png" alt="" fill sizes="132px" className="object-contain"  quality={90}/></div></div>
...
function DesktopTopbar() { return <header className="flex h-[62px] items-center justify-end border-b border-[#f0f1f6] pr-[29px] max-[760px]:hidden"><div className="flex h-full items-center text-[#11183b]"><span className="owner-body relative grid size-[22px] place-items-center"><Icon name="bell" className="size-[19px]" strokeWidth="1.8" /><b className="owner-label absolute -right-[3px] -top-[5px] grid size-[15px] place-items-center rounded-full bg-[#ef3945] text-white">3</b></span><Image src="/owner-selfie-ahmed-reference.png" alt="Ahmed H." width={32} height={32} className="ml-[23px] size-[32px] rounded-full object-cover"  quality={90}/><span className="owner-body ml-[10px]">Ahmed H.</span><Icon name="chevron" className="ml-[9px] size-[12px]" strokeWidth="1.8" /></div></header>; }
...
function PropertySummary({property}:{property:PreviewProperty}) { return <Card className="flex min-h-[172px] gap-[20px] p-[14px] max-[760px]:gap-3 max-[760px]:p-3">
  <div className="relative h-[119px] w-[170px] shrink-0 overflow-hidden rounded-[7px] max-[760px]:h-[105px] max-[760px]:w-[122px]"><Image src="/property-studio-sharp.png" alt="Apartment living room" fill className="object-cover object-center" sizes="170px"  quality={90}/></div>
